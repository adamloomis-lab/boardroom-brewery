    ...
    <>
      <section className="relative flex min-h-[52vh] items-center overflow-hidden">
        ...
        <div className="container-x relative z-10 pt-24 text-center">
          <h1 className="rise rise-2 font-display text-display-lg-mobile font-extrabold text-cream md:text-display-lg">Run Club</h1>
          <p className="rise rise-3 mx-auto mt-5 max-w-2xl text-body-lg text-on-surface">Wednesdays at 6 pm. Lace up, log a few miles, and earn your pour. Everyone's welcome, and the beers will be waiting.</p>
        </div>
      </section>
      ...
      <section className="py-20 md:py-24">
        <div className="container-x">
          <div className="grid gap-4 reveal-group sm:grid-cols-2 lg:grid-cols-4">
            {facts.map((f) => (
              <div key={f.label} className="rounded-[3px] border border-outline-variant bg-surface-card p-7">
          ...
          <div className="mx-auto mt-16 max-w-3xl space-y-8 text-center">
            <div className="reveal"><h3 className="font-display text-headline-sm font-bold text-cream">The Route</h3><p className="mt-3 text-body-lg text-on-surface-variant">{runClub.route}</p></div>
            <div className="reveal"><h3 className="font-display text-headline-sm font-bold text-cream">Your Run Lead</h3><p className="mt-3 text-body-lg text-on-surface-variant">{runClub.leader}</p></div>
            <div className="reveal rounded-[3px] border border-gold/40 bg-surface-card p-8"><h3 className="font-display text-headline-sm font-bold text-gold">Walkers Welcome</h3><p className="mt-3 text-body-lg text-on-surface-variant">{runClub.walkers}</p></div>
          </div>
