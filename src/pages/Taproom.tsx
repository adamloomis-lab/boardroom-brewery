    ...
    <>
      <section className="relative flex min-h-[56vh] items-center overflow-hidden">
        ...
        <div className="container-x relative z-10 pt-24 text-center">
          <h1 className="rise rise-2 font-display text-display-lg-mobile font-extrabold text-cream md:text-display-lg">Come and Visit</h1>
      ...
      <section className="py-20 md:py-24">
        <div className="container-x">
          <SectionHeading title="A Brewery + Event-Space Hybrid" intro="We're open six days a week with rotating beer & seltzers and a relaxed, modern atmosphere." />
          <div className="mt-12 grid gap-4 reveal-group sm:grid-cols-2 lg:grid-cols-3">
            {taproomFeatures.map((f) => (
              <div key={f} className="flex items-center gap-3 rounded-[3px] border border-outline-variant bg-surface-card px-6 py-5">
